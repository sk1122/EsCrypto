...
export default function Creator() {
	...
	return (
		<>
			<Head>
				<title>Sponsor Name - EsCrypt</title>
			</Head> 
			<div className='w-full h-full'>
				...
				<div className="relative z-0 w-full min-h-screen text-inter flex justify-center items-start flex-col sm:flex-row space-x-5 mt-5">
					<span className="absolute bg-violet-800 h-48 w-full"></span>
					...
					<div className="z-50 h-full pb-6 w-full sm:w-1/4 bg-white shadow-md m-6 rounded-md">
						<h2 className="text-lg font-bold ml-10 mt-10">Nudge Sponsor to Hire You😉</h2>

						{!isClicked && 
							<button onClick={(e) => clicked(e)} className="w-3/4 h-10 ml-10 mt-5 bg-violet-900 rounded-md border border-gray-400 focus:ring-1 focus:ring-offset-2 focus:ring-offset-gray-400 focus:ring-indigo-600 text-white">Nudge</button>
						}
						{isClicked && 
							<button onClick={(e) => clicked(e)} className="w-3/4 h-10 ml-10 mt-5 bg-violet-900 rounded-md border border-gray-400 focus:ring-1 focus:ring-offset-2 focus:ring-offset-gray-400 focus:ring-indigo-600 text-white flex justify-center items-center">
